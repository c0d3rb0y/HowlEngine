...
while GetRunning() == False:
    time.sleep(0)
endscene = Scene("endscene", [ReturnText("now u can move this doge across de scren (arrow keys), except no touch smiley face", "end2txt", 100, 180, (0, 255, 0)),
...
textbeforeend = Scene("textbeforeend", [ReturnText("ok that was the engine test cool", "endtxt", 100, 180, (10, 10, 10))])
...
Text("IM HERE NOW TOO HAHAHAHHAHAHAHAHHAHAHAHAHHAHAHAHAHAHHAHAHAHAHAHAHHAHAAHAHAHHAHAHAHAHHAHAHAHAHHA", "hahaobj", 320, 200, (10, 10, 10))
Remove("hiobj")
