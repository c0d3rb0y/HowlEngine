...
while GetRunning() == False:
    time.sleep(0)
endscene = Scene("endscene", [ReturnText("now u can move this doge across de scren (arrow keys), except no touch smiley face", "end2txt", 100, 180),
...
textbeforeend = Scene("textbeforeend", [ReturnText("ok that was the engine test cool", "endtxt", 100, 180)])
